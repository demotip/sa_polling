...
def channels(conversation_df):
    ...
    for x in channel_list[1:]:
        ...
        if next_one == previous:
            ...
            if (previous == '*120*7692*2#' and next_one == '*120*7692*3#') or (
                    next_one == '*120*7692*2#' and previous == '*120*7692*3#'):
                ch1_to_ch2 = True
            if (previous == '*120*7692*3#' and next_one == '*120*4729#') or (
                    next_one == '*120*7692*3#' and previous == '*120*4729#'):
                ch1_to_ch2 = True
            if (previous == '*120*7692*2#' and next_one == '*120*4729#') or (
                    next_one == '*120*7692*2#' and previous == '*120*4729#'):
                ch1_to_ch2 = True
            previous = next_one

    return ch1_to_ch2, ch2_to_ch3, ch1_to_ch3
...
def make_payload(conversation_df):
    ...
    ch1_to_ch2, ch2_to_ch3, ch1_to_ch3 = channels(conversation_df)
